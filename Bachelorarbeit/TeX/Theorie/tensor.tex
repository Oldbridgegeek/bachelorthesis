...
Die \textit{HOSVD} existiert für alle Tensoren, jedoch ist die \textit{HOSVD} keine eindeutige Zerlegung. Dies führen wir an einem beliebigen Tensor dritter Ordnung vor.
